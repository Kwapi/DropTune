/**
 * Created by Michal on 22/03/2016.
 */
!function(e) {
    "function" == typeof define && define.amd ? define(["jquery.barrating.min"], e) : "object" == typeof module && module.exports ? module.exports = e(require("jquery")) : e(jQuery)
}(function(e) {
    var t = function() {
        function t() {
            var t = this
              , n = function() {
                ...
                "" !== t.options.theme && n.push("br-theme-" + t.options.theme),
                t.$elem.wrap(e("<div />", {
                    "class": n.join(" ")
                }))
            }
              ...
              , d = function() {
                ...
                t.options.reverse && n.addClass("br-reverse"),
                t.options.readonly && n.addClass("br-readonly"),
                n
            }
              , f = function() {
              ...
              , g = function(e) {
                t.$elem.find('option[value="' + e + '"]').prop("selected", !0),
                t.$elem.change()
            }
              , p = function(e) {
                e = e ? e : u(),
              ...
              , h = function() {
                t.$widget.find("a").removeClass("br-selected br-current"),
                t.$widget.find('a[data-rating-value="' + c() + '"]').addClass("br-selected br-current")[f()]().addClass("br-selected")
            }
              , b = function(e) {
              ...
              , v = function(n) {
                n.on("click.barrating", function(r) {
                    ...
                    n.removeClass("br-active br-selected"),
                    l.addClass("br-selected")[f()]().addClass("br-selected"),
                    a = l.attr("data-rating-value"),
                    s = l.attr("data-rating-text"),
                    b(l) ? (l.removeClass("br-selected br-current")[f()]().removeClass("br-selected br-current"),
                    a = "",
                    s = "") : (n.removeClass("br-current"),
                    l.addClass("br-current")),
                    o("ratingValue", a),
                    o("ratingText", s),
                    g(a),
                    p(s),
                    d.onSelect.call(t, c(), u(), r),
                    !1
                })
            }
              , m = function(t) {
                t.on("mouseenter.barrating focus.barrating", function() {
                    var n = e(this);
                    t.removeClass("br-active br-selected"),
                    n.addClass("br-active")[f()]().addClass("br-active"),
                    p(n.attr("data-rating-text"))
                })
            }
              , $ = function(e) {
            ...
            this.show = function() {
                ...
                h(),
                p(),
                R(t.options.readonly),
                t.$elem.hide())
            }
            ,
            this.readonly = function(e) {
                "boolean" == typeof e && i("readOnly") != e && (R(e),
                o("readOnly", e),
            ...
            this.set = function(e) {
                var n = i("userOptions");
                t.$elem.find('option[value="' + e + '"]').val() && (o("ratingValue", e),
                o("ratingText", t.$elem.find('option[value="' + e + '"]').text()),
                g(c()),
                p(u()),
                h(),
                n.silent || n.onSelect.call(this, c(), u()))
            }
            ,
            this.clear = function() {
                var e = i("userOptions");
                o("ratingValue", i("originalRatingValue")),
                o("ratingText", i("originalRatingText")),
                g(c()),
                p(u()),
                h(),
                e.onClear.call(this, c(), u())
            }
            ,
        ...
        return this.each(function() {
            ...
            a.hasOwnProperty(n)) {
                ...
                if (a.$elem.data("barrating"))
                    return a.$widget = e(this).next(".br-widget"),
                    a[n](r)
            } else {
